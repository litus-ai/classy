...
class TestProfileApplication:
    ...
    def test_primitive_variable_set_from_profile(self, hydra_test_env):
        before_cfg, after_cfg = self._run_skeleton(
            *hydra_test_env,
            profile=OmegaConf.create({
                'i': 1
    ...
    def test_dict_variable_set_from_profile(self, hydra_test_env):
        before_cfg, after_cfg = self._run_skeleton(
            *hydra_test_env,
            profile=OmegaConf.create({
                'd': {'a': '_a', 'd': '_d'}
    ...
    def test_obj_variable_set_from_profile(self, hydra_test_env):
        before_cfg, after_cfg = self._run_skeleton(
            *hydra_test_env,
            profile=OmegaConf.create({
                'o': {'_target_': 'my.other.custom.module', 'p2': 'p2'}
            }),
            cli=[]
        )
    ...
    def test_additional_variable_set_from_profile(self, hydra_test_env):
        before_cfg, after_cfg = self._run_skeleton(
            *hydra_test_env,
            profile=OmegaConf.create({
                's': 's'
    ...
    def test_interpolation_variable_set_from_profile(self, hydra_test_env):
        before_cfg, after_cfg = self._run_skeleton(
            *hydra_test_env,
            profile=OmegaConf.create({
                'interpolation': 'another-interpolation'
            }),
            cli=[]
        )
