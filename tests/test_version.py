# source: https://github.com/allenai/allennlp/blob/main/tests/version_test.py

import re

import pytest

from classy.version import VERSION


# Regex to check that the current version set in `classy.version` adheres to
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("1.0.0.post1", True),
        ("1.0.0rc3.post0", True),
        ("1.0.0rc3.post0.dev20210424", True),
        # Invalid versions:
        ("1.0.0.rc3", False),
        ("1.0.0rc01", False),
        ("1.0.0rc3.dev2021424", False),
    ],
)
