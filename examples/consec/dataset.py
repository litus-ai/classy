...
from examples.consec.dependency_finder import DependencyFinder
from examples.consec.disambiguation_corpus import DisambiguationInstance, DisambiguationCorpus
from examples.consec.sense_inventories import SenseInventory
from examples.consec.tokenizer import ConsecTokenizer
