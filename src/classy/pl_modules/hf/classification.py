...
from ..base import ClassificationOutput, ClassyPLModule
from ..mixins.task import QATask, SentencePairTask, SequenceTask, TokensTask
...
class HFSequenceCommonPLModule(ClassyPLModule, ABC):
    def __init__(
        ...
        self.micro_f1_metric = torchmetrics.F1Score()
        self.macro_f1_metric = torchmetrics.F1Score(num_classes, average="macro")
